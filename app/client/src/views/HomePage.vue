...
<template>
  <main class="relative scroll-smooth scroll-pt-12 flex-1 dark:text-gray-100">
    ...
    <section
      id="presentation"
      class="mt-16 container flex flex-col justify-center relative"
    >
      <!--
      ...
      "Evening, sleepyhead!"
      -->
      <h3 id="presentation-greetings" class="text-2xl">
        {{ $t(`welcomePhases.${getDayPeriods()}[${randomInt(0, 2)}]`) }}
      </h3>
      <h1
        id="presentation-self"
        class="font-semibold tracking-tight text-gray-900 text-2xl md:text-4x lg:text-6xl dark:text-white"
      >
        {{ $t("presentation.im") }} Alexsander P. F. Santos
      </h1>
      <div
        id="presentation-self-description"
        class="animate-[appear-to-top_1s_1s_ease_infinite]"
      >
    ...
    <span id="end-main">
      <section id="skills" class="container mt-12">
        ...
        <div
          class="flex flex-wrap gap-4 items-center mt-4 text-gray-700 dark:text-gray-100"
        >
          <article
      ...
      <section id="contacts" class="mt-12 container grid items-center">
        ...
        <section class="flex gap-6 justify-center mb-8 mt-4">
          <Card
            class="aspect-[5/6] w-[250px] flex flex-col hover:scale-105 transition-transform shadow-sm"
          >
            <CardHeader>
            ...
            <CardFooter class="flex-1">
              <a
                href="https://www.linkedin.com/in/alexsander-p-f-santos/"
                target="_blank"
                class="ml-auto mt-auto"
              >
                <Button variant="outline" class="text-blue-600 dark:text-blue-400"
                  >View Profile
                </Button></a
              >
            </CardFooter>
          ...
          >
            ...
            <CardContent>
              <img
                src="https://avatars.githubusercontent.com/u/82063944?v=4"
                class="aspect-square h-14 rounded-full"
                alt="Alexsander Patrick Ferreira Santos"
              />
            ...
            <CardFooter class="flex-1">
              <a
                href="https://github.com/Alexsander33set"
                target="_blank"
                class="ml-auto mt-auto"
                ><Button variant="outline">View Profile</Button></a
              >
            </CardFooter>
          </Card>
          ...
          >
            ...
            <CardContent>
              <span class="relative">
                <img
                  src="../assets/images/gmail-profile-image.jpg"
                  class="aspect-square h-14 rounded-full"
                  alt="Email profile"/>
            ...
            <CardFooter class="flex-1">
              <a
                href="mailto:alexsander.patrick@gmail.com"
                target="_blank"
                class="ml-auto mt-auto"
                ><Button variant="outline" class="text-jasper-500 dark:text-jasper-500"
                  >Send Email</Button
                ></a
              >
            </CardFooter>
    ...
    <div
      class="absolute top-20 -right-2 hover:-right1 p-2 hover:scale-105 cursor-pointer border rounded-sm text-center bg-white duration-300 hover:shadow-md opacity-50 hover:opacity-100 transition-all"
      @click="TOCisOpen = !TOCisOpen"
      @mouseleave="TOCisOpen = false"
    >
      <Icon
        icon="mdi:menu-left"
        class="scale-150 transition-all duration-300"
        :class="{ 'rotate-180': TOCisOpen }"
      />
...
#presentation > *, #end-main {
  opacity: 0;
  animation: appear-to-top 800ms ease-out forwards;
}
