...
console.log(`Projects ID from URL : ${projectID} with type ${typeof projectID}
        Projects ID 0 : ${projects.value[0]?._id} with type ${typeof projects.value[0]
  ?._id}`);
...
<template>
  <main class="p-8 flex-1">
    ...
    <template v-if="project">
      ...
      <section id="technologies" class="pt-4">
        <h4 class="text-xl">
          ...
          <div class="pt-2 inline-flex gap-2">
            <Badge
              class="capitalize leading-normal inline-flex gap-2"
      ...
      <section
        id="proj-description"
        class="mt-4 p-4 rounded-xl bg-slate-100 dark:bg-slate-900"
      >
        <div
          class="whitespace-pre-wrap min-w-full prose lg:prose-xs flex-1 dark:text-white"
        >
